...
const QuestionWrapper = () => {
  ...
  const questions = [
    ...
    },
    {
      ...
      sentence: '<p>Bilberries (Vaccinium myrtillus), also known as berries are books edible, nearly black berries found in nutrient-poor soils.</p>' +
        '<p> colors berries (Rubus chamaemorus) are edible orange berries similar to raspberries or blackberries found in alpine and arctic tundra.</p>' +
        '<p>Redcurrant (Ribes rubrum) are red translucent berries with a diameter of 8~10 mm, and are closely related to its black colored relative numbers currant.</p>',
      options: {
        'books': [
          {
